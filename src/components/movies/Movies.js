...
class Movies extends Component {
    ...
    fetchMovies(searchPage) {
        this.setState({
            ...
            fetchWithToken(`/findMovies/${this.state.searchName}/${this.state.searchYear || -1}/${this.state.searchPage}`, {method: 'GET'})
                .then(response => {
    ...
    render() {
        return (
            <div className='container-fluid'>
                ...
                <MovieList movies={this.state.movies.list} loading={this.state.movies.loading}
